...
@section('contenido')
	...
	<form method="POST" action="/proveedores">
		...
		<div class="form-group {{ $errors->has('tradename') ? 'has-error' : '' }}">
			...
			<input type="text" name="tradename" class="form-control" value="{{ old('tradename') }}" placeholder="Nombre comercial" autofocus />
		...
		<div class="form-group {{ $errors->has('commercial_address') ? 'has-error' : '' }}">
			...
			<textarea name="commercial_address" class="form-control" placeholder="Dirección comercial">{{ old('commercial_address') }}</textarea>
		...
		<div class="form-group {{ $errors->has('contact_name') ? 'has-error' : '' }}">
			...
			<input type="text" name="contact_name" class="form-control" value="{{ old('contact_name') }}" placeholder="Contacto (Nombre)" />
		...
		<div class="form-group {{ $errors->has('contact_address') ? 'has-error' : '' }}">
			...
			<input type="text" name="contact_address" class="form-control" value="{{ old('contact_address') }}" placeholder="Contacto (Dirección)" />
		...
		<div class="form-group {{ $errors->has('contact_phone') ? 'has-error' : '' }}">
			...
			<input type="text" name="contact_phone" class="form-control" value="{{ old('contact_phone') }}" placeholder="Contacto (Telefono)" />
		...
		<div class="form-group {{ $errors->has('contact_email') ? 'has-error' : '' }}">
			...
			<input type="text" name="contact_email" class="form-control" value="{{ old('contact_email') }}" placeholder="Contacto (E-mail)" />
